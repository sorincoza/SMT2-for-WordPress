  ...
  var smtRec = {
    ...
    trackIFrames: function(d)
    {
      ...
      for (var i = 0, f = iframes.length; i < f; ++i) {
        ...
        // fix https from http conflict (added by me - try/catch block):
        // ( when we have an iframe with 'https' source, the browser throws security error if the site is 'http' )
        // ( an example is when we use google maps )
        try{
