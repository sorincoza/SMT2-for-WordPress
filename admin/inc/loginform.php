...
if (!$isInstalled) {
  ...
  $msg .= 'Database not found or misconfigured! You probably do not have SMT2 installed yet.';
  $msg .= '<br/><br>';
  $msg .= 'Go to &nbsp;<a href="'.ABS_PATH.'admin/sys/'.'install.php"><b>installation page</b></a>&nbsp; now.';
  $msg .= '<br><br><br>';
  $msg .= '</p>';
  echo $msg;
  exit;
